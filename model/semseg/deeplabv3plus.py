...
from model.models.model.modules.backbones.res2net_dal import res2net_dla60, res2next_dla60
...
class DeepLabV3Plus(nn.Module):
    def __init__(self, cfg):
        ...
        if cfg['backbone']=="resnet50":
            ...
            self.backbone = HRNet_Backbone(backbone="hrnetv2_w18",pretrained=cfg['pretrained'])
            low_channels = 256
            high_channels = 480
        else:
