...
input_file = r'D:\study\banjiandu\UniMatch-main\Erhai semantic segmentation\splits\val\train17.txt'
output_file = './val.txt'
...
with open(input_file, 'r') as f_input, open(output_file, 'w') as f_output:
    ...
    for line in lines:
        line = line.strip()
        image_name = f"JPEGImages/{line}.tif"
        seg_name = f"SegmentationClass/{line}.tif"
        output_line = f"{image_name} {seg_name}\n"
        f_output.write(output_line)
