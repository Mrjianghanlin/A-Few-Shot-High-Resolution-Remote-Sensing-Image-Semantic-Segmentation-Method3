...
# 定义图像路径
image_file = r'C:\Users\wang\Desktop\data\yuanwenjian\image\28_8_bands.tif'
# image_file = r'C:\Users\wang\Desktop\data\yuanwenjian\label\28_label.tif'
#
# 定义裁剪后的图像的大小和步长
crop_size_x = 512
crop_size_y = 512
...
# 创建输出文件夹
output_folder = r'C:\Users\wang\Desktop\data\28_image'
...
for y in range(0, image_size_y - crop_size_y + 1, step_y):
    for x in range(0, image_size_x - crop_size_x + 1, step_x):
        output_image_file = os.path.join(output_folder, f'image_u_28_{x}_{y}.tif')
...
#
# # 合并裁剪后的图像
# merged_image_file = os.path.join(output_folder, 'merged_image_3.tif')
# driver = gdal.GetDriverByName('GTiff')
...
# for y in range(0, image_size_y - crop_size_y + 1, step_y):
#     for x in range(0, image_size_x - crop_size_x + 1, step_x):
#         input_image_file = os.path.join(output_folder, f'image_3_{x}_{y}.tif')
